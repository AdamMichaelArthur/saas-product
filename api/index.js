...
console.log(11, process.env.JSON_BODY_POST_SIZE_LIMIT, process.env.TEXT_BODY_POST_SIZE_LIMIT);

if(nodeVersions[0] < 18){
	console.error(nodeVersions, "This project requires Node Version 18 or greater");
	process.exit(1);
}
