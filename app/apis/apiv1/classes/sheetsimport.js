/*
	This is a port of the 'excelimport.js' for google sheets.  The objective is to produce
	output that would be identical for identical spreadsheets.

	One key difference here is we only support one worksheet at a time.
	The excelimport can import an entire workbook.

	The cheater-way would be to download the spreadsheet as an excel file and then
	just use that.
*/
...
module.exports = class SheetsImport {
